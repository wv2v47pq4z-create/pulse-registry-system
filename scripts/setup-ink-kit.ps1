<#
.SYNOPSIS
  Automates setup for inkonchain/ink-kit on Windows PowerShell.
...
.PARAMETER RepoUrl
  Repo URL to clone. Default: https://github.com/inkonchain/ink-kit.git
...
param(
    ...
    [string]$RepoUrl = "https://github.com/inkonchain/ink-kit.git",
