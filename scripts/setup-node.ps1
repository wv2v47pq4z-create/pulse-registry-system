<#
.SYNOPSIS
  Automates setup for inkonchain/node on Windows PowerShell.
...
.PARAMETER RepoUrl
  Repo URL to clone. Default: https://github.com/inkonchain/node.git
...
param(
    ...
    [string]$RepoUrl = "https://github.com/inkonchain/node.git",
